...
//   } catch (error) {
//     console.error('خطا در تجزیه locations:', error);
//     locations = [];
//   }
...
//       const { coordinates, description } = location;
...
var displayMap = exports.displayMap = function displayMap(locations) {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var map = new maplibregl.Map({
      container: 'map',
      style: 'https://api.maptiler.com/maps/streets-v2/style.json?key=bxiJzSzJF8UeNiTIc9fp',
      center: [-118.113491, 34.111745],
      zoom: 1,
      interactive: true,
      scrollZoom: false
    ...
    map.on('load', function () {
      ...
      locations.forEach(function (location) {
        ...
        new maplibregl.Marker({
          element: el,
          anchor: 'bottom'
        }).setLngLat(coordinates).setPopup(new maplibregl.Popup({
          offset: 30
        }).setHTML("<p>Day ".concat(day, " : ").concat(description, "</p>"))).addTo(map);
        bounds.extend(coordinates);
      });
      map.fitBounds(bounds, {
        padding: {
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */ // import '@babel/polyfill'
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Error loggingOut! try agian later');
        case 10:
        case "end":
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "12822" + '/');
